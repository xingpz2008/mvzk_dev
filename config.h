...
#define MVZK_CONFIG_TENSOR_CHECK_CNT 100
#define MVZK_CONFIG_MATMUL_TENSOR_CHECK_CNT 100
...
#define MVZK_CONFIG_RANGE_CHECK_REQUEST_BUFFER_THRESHOLD 4096
#define MVZK_CONFIG_LUT_REQUEST_BUFFER_THRESHOLD 4096
...
// =================================================================
// 动态 OpenMP 调度阈值 (应对 Thread Thrashing 线程自杀问题)
// =================================================================
// 1. 空间维度：当 Tensor 的 total_elements >= 此值时，才开启内部 size 级并行
#define MVZK_OMP_SIZE_THRESHOLD 256

// 2. 阶数维度：针对 size 极小但阶数爆炸的连乘，当 degree >= 此值时，开启外部 k 级并行
#define MVZK_OMP_DEGREE_THRESHOLD 32
